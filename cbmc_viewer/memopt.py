...
################################################################
# Define parser to independently collect memory op call metrics
# run: memopt.py -i <input_file> --srcdir <srcdir> --outdir <outdir>

def create_parser():

    parser = argparse.ArgumentParser(
        description='Report CBMC Memory Operation Call metrics.'
    )
...
def main():
    ...
    MemOpSummary(file, srcdir).dump(outdir=outdir)
