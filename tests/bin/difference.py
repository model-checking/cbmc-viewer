...
def load_run_json(proof_root, litani):
...
def viewer_add_job_commands(proof_root, litani):
    """The litani add-job commands used to invoke viewer"""

    run_json = load_run_json(proof_root, litani)
...
def run_viewer(proof_root, viewer1, root1, viewer2, root2, litani):
    ...
    viewer_jobs = viewer_add_job_commands(proof_root, litani)
